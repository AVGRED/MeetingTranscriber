 ...
 */
class ParaformerEngine(keys: EngineKeys) : CloudAsrWsEngine(keys) {
    ...
    override fun buildRequest(config: AsrConfig): Request {
        val apiKey = provider.credential(keys, 0)
        ...
        val runTask = JSONObject().apply {
            ...
            put("payload", JSONObject().apply {
                ...
                put("parameters", JSONObject().apply {
                    ...
                    if (config.language == "cn") put("language_hints", org.json.JSONArray().put("zh"))
                })
